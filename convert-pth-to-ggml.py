...
def main():
    ...
    timm_model = timm.create_model(args.model_name, pretrained=True, pretrained_cfg_overlay=dict(file="./model/model.safetensors"))
    ...
    with open(fname_out, "wb") as fout:
        ...
        fout.write(struct.pack("i", args.ftype))  # 1:float16
